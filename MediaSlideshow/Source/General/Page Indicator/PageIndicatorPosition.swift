...
public struct PageIndicatorPosition {
    ...
    /// Computes the additional padding needed for the page indicator under the MediaSlideshow
    ///
    /// - Parameter indicatorSize: size of the page indicator
    /// - Returns: padding needed under the MediaSlideshow
    ...
    ///
    /// - Parameters:
    ///   - parentFrame: frame of the parent view – MediaSlideshow
    ///   - indicatorSize: size of the page indicator
    ///   - edgeInsets: edge insets of the parent view – MediaSlideshow (used for SafeAreaInsets adjustment)
